...
function ShieldOkIcon() {
  return (
    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" aria-hidden>
      ...
      />
      <defs>
        <linearGradient id="infoShieldOk" x1="12" y1="8" x2="42" y2="48" gradientUnits="userSpaceOnUse">
...
function ShieldFailIcon() {
  return (
    <svg width="56" height="56" viewBox="0 0 56 56" fill="none" aria-hidden>
      ...
      />
      <defs>
        <linearGradient id="infoShieldFail" x1="12" y1="8" x2="42" y2="48" gradientUnits="userSpaceOnUse">
    ...
    <Drawer open={open} title="核验详情" onClose={onClose} width={520}>
      <div className="c-cert-detail">
        ...
        <dl className="c-cert-detail__meta">
          ...
          <div className="c-cert-detail__row">
            <dt>类型</dt>
            <dd>{INFO_WORK_TYPE_LABEL[result.workType]}</dd>
          </div>
        </dl>

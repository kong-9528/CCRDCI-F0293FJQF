...
let articles: HelpArticle[] = [
  // —— 门户接入指南 ——
  {
    ...
    views: 1280,
    summary: "平台能力与开通方式总览",
    body: "<p>DCI<sup class=\"a-tm\">®</sup>技术服务中心面向企业客户，提供版权核验与智能辅助审核服务。</p>",
    maintainer: "运营管理员",
  ...
  },
  {
    ...
    views: 640,
    summary: "登录后进入客户工作台",
    body: "<p>登录成功后，导航栏将出现「DCI<sup class=\"a-tm\">®</sup>技术服务中心」入口。</p>",
    maintainer: "王编辑",
  ...
  // —— 控制台帮助中心 ——
  {
    ...
    body: "<p>欢迎使用 DCI<sup class=\"a-tm\">®</sup>技术服务中心。本文档将帮助您快速了解平台功能并完成 API 接入。</p><p>典型路径：确认已开通产品 → 获取密钥 → 按文档联调 → 上线调用。</p>",
    maintainer: "运营管理员",
    updatedAt: "2026-08-01 14:00:00",
    deleted: false,
  },

...
const NAV_ICON_MAP: Record<string, ComponentType<IconProps>> = {
  ...
  "/stats/usage-records": IconStatsProducts,
  "/stats/verify/customers": IconStatsCustomers,
  "/stats/verify/products": IconStatsProducts,
  "/stats/verify/account-products": IconStatsProducts,
  "/stats/verify/usage-records": IconStatsProducts,
  "/stats/audit/customers": IconStatsCustomers,
  "/stats/audit/products": IconStatsProducts,
  "/stats/audit/account-products": IconStatsProducts,
  "/stats/audit/usage-records": IconStatsProducts,
...
const GROUP_ICON_MAP: Record<string, ComponentType<IconProps>> = {
  ...
  "stats-verify": IconStatsCustomers,
  "stats-audit": IconStatsCustomers,
  content: IconPortal,
  system: IconRoles,
};

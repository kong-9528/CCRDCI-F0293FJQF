...
export const INTEGRATION_GUIDE: HelpGuideNode[] = [
  {
    ...
    html: `
      ...
      <p>可在门户完成账号注册（用户名与手机号全局唯一）。产品权限与调用额度仍需线下签约后由运营开通。</p>
    `,
  },
  {
    type: "folder",
    ...
    children: [
      {
        ...
        id: "faq-register",
        title: "如何注册账号？",
        html: `<p>点击导航「注册」进入注册页，或在登录弹窗中选择「注册账号」。需填写唯一账号名、8–12 位密码、唯一手机号，并完成图形验证码与短信验证；勾选用户协议与隐私协议后方可注册。产品权限仍需线下签约后开通。</p>`,
      },
      {
        type: "article",
        id: "faq-password",
